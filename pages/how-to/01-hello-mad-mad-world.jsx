  ...
  return (
    <article className={bem("")}>
      ...
      <p>
        ...
        <a href="/installation" title="install Madlib">
          install Madlib
        </a>
      ...
      <pre>
        <code className="hljs language-sh">npm i @madlib-lang/madlib -g</code>
      </pre>
...
>`}
      ...
      <p>
        ...
        <a href="/05-the-march-of-ides" title="programming environment">
      ...
      <pre>
        <code className="hljs language-mad">
      ...
      <pre>
        <code className="hljs language-mad">&gt; import Math from "Math"</code>
      </pre>
      ...
      <ul>
        <li>
          <p>
            <a href="/01-hello-mad-mad-world#installation" title="Installing">
              Installing
            </a>{" "}
            Madlib
          </p>
        ...
        <li>
          <p>
            Using the{" "}
            <a href="/01-hello-mad-mad-world#repl" title="REPL">
              REPL
            </a>
          </p>
        </li>
        ...
        <li>
          <p>
            <a href="/01-hello-mad-mad-world" title="Importing">
              Importing
            </a>{" "}
